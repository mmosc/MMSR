...
def get_PCA_selection(features: np.array, n_components=0.99):
...
def get_ICA_selection(features: np.array, n_components: int = 100):
...
def get_TSNE_selection(features: np.array, n_components: int = 100):
